...
// verbatim from the source documents in reference/Agreements/HMARK Student
// Contract - {Italy,Germany (Public),Australia,Canada,TRNC,UK,USA}.docx.
...
// (Germany (Private) has no matching destination yet, so isn't wired up).
//
...
//
// Italy/Germany (Public) use the source docs' own numbered clauses (kind:
// "clause"). Australia/Canada/Northern Cyprus/UK/USA have no clause numbering
...
export const AGREEMENT_CONTENT: Record<string, AgreementContent> = {
  ...
  // AT_public, FR_public, FI_public, LU_public adapted from DE_public at the
  // user's direction (2026-08-28) — no source .docx exists for these in
  // reference/Agreements/. Same structure, fee terms, and refund policy as
  // the Germany (Public) contract (same track: EU public-university
  // admission, no scholarship-body machinery like Italy's), with country
  // references swapped. Two deviations from a pure find-replace, same
  // treatment used for Ireland (adapted from UK): (1) Germany's clause about
  // a scholarship being "revoked"/re-awarded for missing the enrollment
  // deadline is a Germany-specific claim (public-university semester
  // scholarships) that hasn't been verified for these destinations, so it's
  // replaced with the same generic deadline clause used in the UK/TRNC
  // contracts; (2) the "[NO BANK FINANCE ARE ALLOWED FOR ... VISA]" bracket
  // is a specific immigration-finance claim dropped rather than swapped,
  ...
  AT_public: {
    ...
    blocks: [
      ...
      {
        kind: "bullet",
        text: "Students are required to provide IELTS overall band 6.5 for postgraduate and Undergraduate students and not less than 6 in each component as it is the mandatory requirement of the Austrian universities and Embassy/Consulate.",
      },
      { kind: "bullet", text: "Students are required to meet the deadlines of the Embassy/Consulate. Else the admission will be deferred to next possible intake." },
      {
        kind: "bullet",
        text: "The client is required to provide the information of any kind of visa previously issued or refused.",
      },
      ...
      {
        kind: "bullet",
        text: "In the event that the CLIENT chooses to terminate this agreement prior to either of the event made registration with HMARK Consultants or submitted for student visa to Austria, the full amount of the agreement client has to pay.",
      },
      {
        kind: "bullet",
        text: "The client understand that a refusal from university or embassy based on the medical condition, criminality, fraudulent documents, false or misleading information or the ability to meet the admissibility requirements will not be the responsibility of the consultant or the company and there will be no refund made in this condition.",
      ...
      {
        kind: "bullet",
        text: "In case of visa rejection from the embassy, there will be no refund made to the client. The paid consultation fee is limited to the admission in public university of Austria only.",
      },
      {
        kind: "paragraph",
        text: "If however the application is denied because of an error or omission on the part of HMARK Consultants or professional staff, the HMARK Consultants will refund all professional fee collected and the administrative charges will be non-refundable. The Client(s) agrees that the fees paid are for services indicated above, and any refund is strictly limited to the amount of fees paid.",
      ...
      {
        kind: "paragraph",
        text: "Please be noted that HMARK Consultants is an official representative of the private universities it represents. HMARK Consultants is not an official representative of any public university of Austria and only process the admission application on behalf the client's consent.",
      },
      {
        kind: "paragraph",
        text: "In the event of dispute, the Client(s) and HMARK Consultants are to make every effort to resolve the matter between the two parties. In the event a resolution cannot be reached, the Client(s) are to make a complain in writing to HMARK Consultants and allow the HMARK Consultants 30 to 60 days to respond to the Client(s). In the event the dispute is still unresolved, the Client(s) may follow the complaint and discipline procedure outlined by the university you applied for.",
      ...
      },
      {
        ...
        heading: "NOTE: AT THE TIME OF STUDENT VISA APPLICATION",
        intro:
          "Proof of sufficient funds to cover your tuition and living expenses for at least your whole course in Austria. Please submit: copies of your bank statement of last six months (Must). Any additional supporting documents demonstrating a reliable source of funds (notarized letter of undertaking and financial documents from personal or immediate family, official letter of scholarship or financial award, investment, income from rental properties, etc.). THERE IS NO GUARANTEE OF VISA; WE ARE JUST RESPONSIBLE TO PROCESS YOUR APPLICATION.",
      },
      {
        kind: "clause",
        number: "16.",
        heading: "Authority To Release Personal Information To Designated Universities",
        intro:
          "I, as client authorized HMARK Consultants to serve as my representative and to conduct business and do all type of correspondence on my behalf with the public universities of Austria. I also authorized to release information from my case file and any dependent children under 18 years of age (if applicable). Also I have fully read and understood the agreement and comply with all the clauses in this agreement.",
      },
      {
        kind: "clause",
        number: "17.",
        heading: "Courier Charges",
        intro: "Client has to bear all DHL charges once DHL launch to Austria. We will provide DHL tracking number every time.",
      },
    ],
  },
  ...
  FR_public: {
    ...
    blocks: [
      ...
      {
        kind: "bullet",
        text: "Students are required to provide IELTS overall band 6.5 for postgraduate and Undergraduate students and not less than 6 in each component as it is the mandatory requirement of the French universities and Embassy/Consulate.",
      },
      { kind: "bullet", text: "Students are required to meet the deadlines of the Embassy/Consulate. Else the admission will be deferred to next possible intake." },
      {
        kind: "bullet",
      ...
      {
        kind: "bullet",
        text: "In the event that the CLIENT chooses to terminate this agreement prior to either of the event made registration with HMARK Consultants or submitted for student visa to France, the full amount of the agreement client has to pay.",
      },
      {
        kind: "bullet",
        text: "The client understand that a refusal from university or embassy based on the medical condition, criminality, fraudulent documents, false or misleading information or the ability to meet the admissibility requirements will not be the responsibility of the consultant or the company and there will be no refund made in this condition.",
      ...
      {
        kind: "bullet",
        text: "In case of visa rejection from the embassy, there will be no refund made to the client. The paid consultation fee is limited to the admission in public university of France only.",
      },
      {
        kind: "paragraph",
        text: "If however the application is denied because of an error or omission on the part of HMARK Consultants or professional staff, the HMARK Consultants will refund all professional fee collected and the administrative charges will be non-refundable. The Client(s) agrees that the fees paid are for services indicated above, and any refund is strictly limited to the amount of fees paid.",
      ...
      {
        kind: "paragraph",
        text: "Please be noted that HMARK Consultants is an official representative of the private universities it represents. HMARK Consultants is not an official representative of any public university of France and only process the admission application on behalf the client's consent.",
      },
      {
        kind: "paragraph",
        text: "In the event of dispute, the Client(s) and HMARK Consultants are to make every effort to resolve the matter between the two parties. In the event a resolution cannot be reached, the Client(s) are to make a complain in writing to HMARK Consultants and allow the HMARK Consultants 30 to 60 days to respond to the Client(s). In the event the dispute is still unresolved, the Client(s) may follow the complaint and discipline procedure outlined by the university you applied for.",
      ...
      },
      {
        ...
        heading: "NOTE: AT THE TIME OF STUDENT VISA APPLICATION",
        intro:
          "Proof of sufficient funds to cover your tuition and living expenses for at least your whole course in France. Please submit: copies of your bank statement of last six months (Must). Any additional supporting documents demonstrating a reliable source of funds (notarized letter of undertaking and financial documents from personal or immediate family, official letter of scholarship or financial award, investment, income from rental properties, etc.). THERE IS NO GUARANTEE OF VISA; WE ARE JUST RESPONSIBLE TO PROCESS YOUR APPLICATION.",
      },
      {
        kind: "clause",
        number: "16.",
        heading: "Authority To Release Personal Information To Designated Universities",
        intro:
          "I, as client authorized HMARK Consultants to serve as my representative and to conduct business and do all type of correspondence on my behalf with the public universities of France. I also authorized to release information from my case file and any dependent children under 18 years of age (if applicable). Also I have fully read and understood the agreement and comply with all the clauses in this agreement.",
      },
      {
        kind: "clause",
        number: "17.",
        heading: "Courier Charges",
        intro: "Client has to bear all DHL charges once DHL launch to France. We will provide DHL tracking number every time.",
      },
    ],
  },
  ...
  FI_public: {
    ...
    blocks: [
      ...
      {
        kind: "bullet",
        text: "Students are required to provide IELTS overall band 6.5 for postgraduate and Undergraduate students and not less than 6 in each component as it is the mandatory requirement of the Finnish universities and Embassy/Consulate.",
      },
      { kind: "bullet", text: "Students are required to meet the deadlines of the Embassy/Consulate. Else the admission will be deferred to next possible intake." },
      {
        kind: "bullet",
      ...
      {
        kind: "bullet",
        text: "In the event that the CLIENT chooses to terminate this agreement prior to either of the event made registration with HMARK Consultants or submitted for student visa to Finland, the full amount of the agreement client has to pay.",
      },
      {
        kind: "bullet",
        text: "The client understand that a refusal from university or embassy based on the medical condition, criminality, fraudulent documents, false or misleading information or the ability to meet the admissibility requirements will not be the responsibility of the consultant or the company and there will be no refund made in this condition.",
      ...
      {
        kind: "bullet",
        text: "In case of visa rejection from the embassy, there will be no refund made to the client. The paid consultation fee is limited to the admission in public university of Finland only.",
      },
      {
        kind: "paragraph",
        text: "If however the application is denied because of an error or omission on the part of HMARK Consultants or professional staff, the HMARK Consultants will refund all professional fee collected and the administrative charges will be non-refundable. The Client(s) agrees that the fees paid are for services indicated above, and any refund is strictly limited to the amount of fees paid.",
      ...
      {
        kind: "paragraph",
        text: "Please be noted that HMARK Consultants is an official representative of the private universities it represents. HMARK Consultants is not an official representative of any public university of Finland and only process the admission application on behalf the client's consent.",
      },
      {
        kind: "paragraph",
        text: "In the event of dispute, the Client(s) and HMARK Consultants are to make every effort to resolve the matter between the two parties. In the event a resolution cannot be reached, the Client(s) are to make a complain in writing to HMARK Consultants and allow the HMARK Consultants 30 to 60 days to respond to the Client(s). In the event the dispute is still unresolved, the Client(s) may follow the complaint and discipline procedure outlined by the university you applied for.",
      ...
      },
      {
        ...
        heading: "NOTE: AT THE TIME OF STUDENT VISA APPLICATION",
        intro:
          "Proof of sufficient funds to cover your tuition and living expenses for at least your whole course in Finland. Please submit: copies of your bank statement of last six months (Must). Any additional supporting documents demonstrating a reliable source of funds (notarized letter of undertaking and financial documents from personal or immediate family, official letter of scholarship or financial award, investment, income from rental properties, etc.). THERE IS NO GUARANTEE OF VISA; WE ARE JUST RESPONSIBLE TO PROCESS YOUR APPLICATION.",
      },
      {
        kind: "clause",
        number: "16.",
        heading: "Authority To Release Personal Information To Designated Universities",
        intro:
          "I, as client authorized HMARK Consultants to serve as my representative and to conduct business and do all type of correspondence on my behalf with the public universities of Finland. I also authorized to release information from my case file and any dependent children under 18 years of age (if applicable). Also I have fully read and understood the agreement and comply with all the clauses in this agreement.",
      },
      {
        kind: "clause",
        number: "17.",
        heading: "Courier Charges",
        intro: "Client has to bear all DHL charges once DHL launch to Finland. We will provide DHL tracking number every time.",
      },
    ],
  },
  ...
  LU_public: {
    ...
    blocks: [
      ...
      {
        kind: "bullet",
        text: "Students are required to provide IELTS overall band 6.5 for postgraduate and Undergraduate students and not less than 6 in each component as it is the mandatory requirement of the Luxembourg universities and Embassy/Consulate.",
      },
      { kind: "bullet", text: "Students are required to meet the deadlines of the Embassy/Consulate. Else the admission will be deferred to next possible intake." },
      {
        kind: "bullet",
      ...
      {
        kind: "bullet",
        text: "In the event that the CLIENT chooses to terminate this agreement prior to either of the event made registration with HMARK Consultants or submitted for student visa to Luxembourg, the full amount of the agreement client has to pay.",
      },
      {
        kind: "bullet",
        text: "The client understand that a refusal from university or embassy based on the medical condition, criminality, fraudulent documents, false or misleading information or the ability to meet the admissibility requirements will not be the responsibility of the consultant or the company and there will be no refund made in this condition.",
      ...
      {
        kind: "bullet",
        text: "In case of visa rejection from the embassy, there will be no refund made to the client. The paid consultation fee is limited to the admission in public university of Luxembourg only.",
      },
      {
        kind: "paragraph",
        text: "If however the application is denied because of an error or omission on the part of HMARK Consultants or professional staff, the HMARK Consultants will refund all professional fee collected and the administrative charges will be non-refundable. The Client(s) agrees that the fees paid are for services indicated above, and any refund is strictly limited to the amount of fees paid.",
      ...
      {
        kind: "paragraph",
        text: "Please be noted that HMARK Consultants is an official representative of the private universities it represents. HMARK Consultants is not an official representative of any public university of Luxembourg and only process the admission application on behalf the client's consent.",
      },
      {
        kind: "paragraph",
        text: "In the event of dispute, the Client(s) and HMARK Consultants are to make every effort to resolve the matter between the two parties. In the event a resolution cannot be reached, the Client(s) are to make a complain in writing to HMARK Consultants and allow the HMARK Consultants 30 to 60 days to respond to the Client(s). In the event the dispute is still unresolved, the Client(s) may follow the complaint and discipline procedure outlined by the university you applied for.",
      ...
      },
      {
        ...
        heading: "NOTE: AT THE TIME OF STUDENT VISA APPLICATION",
        intro:
          "Proof of sufficient funds to cover your tuition and living expenses for at least your whole course in Luxembourg. Please submit: copies of your bank statement of last six months (Must). Any additional supporting documents demonstrating a reliable source of funds (notarized letter of undertaking and financial documents from personal or immediate family, official letter of scholarship or financial award, investment, income from rental properties, etc.). THERE IS NO GUARANTEE OF VISA; WE ARE JUST RESPONSIBLE TO PROCESS YOUR APPLICATION.",
      },
      {
        kind: "clause",
        number: "16.",
        heading: "Authority To Release Personal Information To Designated Universities",
        intro:
          "I, as client authorized HMARK Consultants to serve as my representative and to conduct business and do all type of correspondence on my behalf with the public universities of Luxembourg. I also authorized to release information from my case file and any dependent children under 18 years of age (if applicable). Also I have fully read and understood the agreement and comply with all the clauses in this agreement.",
      },
      {
        kind: "clause",
        number: "17.",
        heading: "Courier Charges",
        intro: "Client has to bear all DHL charges once DHL launch to Luxembourg. We will provide DHL tracking number every time.",
      },
    ],
  },
  ...
  AU_private: {
    ...
    blocks: [
      ...
      {
        kind: "bullet",
        text: "Students are required to provide IELTS overall band 6.5 for postgraduate and Undergraduate students and not less than 6 in each component as it is the mandatory requirement of the university and Embassy/Consulate.",
      },
      { kind: "bullet", text: "Students are required to meet the deadlines of Embassy/Consulate. Else the admission will be deferred to next possible intake." },
      { kind: "bullet", text: "The client is required to provide the information of any kind of visa previously issued or refused." },
      {
        kind: "heading",
        heading: "Authorization",
        intro:
      ...
      {
        kind: "bullet",
        text: "In the event that the CLIENT chooses to terminate this agreement prior to either of the event made registration with HMARK Consultants or submitted for student visa to AUSTRALIA, the full amount of the agreement client has to pay.",
      },
      {
        kind: "bullet",
        text: "The client understand that a refusal from university or embassy based on the medical condition, criminality, fraudulent documents, false or misleading information or the ability to meet the admissibility requirements will not be the responsibility of the consultant or the company and there will be no refund made in this condition.",
      ...
      {
        kind: "bullet",
        text: "In case of visa rejection from the embassy, 50% of the total consultancy will be refunded to the client via bank transfer or cheque in 60 working days.",
      },
      {
        kind: "paragraph",
        text: "If however the application is denied because of an error or omission on the part of HMARK Consultants or professional staff, the HMARK Consultants will refund all professional fee collected. The Client(s) agrees that the fees paid are for services indicated above, and any refund is strictly limited to the amount of fees paid.",
      },
      { kind: "subheading", text: "Dispute Resolution" },
      { kind: "paragraph", text: "Please be noted that HMARK Consultants is an official representative of the private universities it represents." },
      {
        kind: "paragraph",
        text: "In the event of dispute, the Client(s) and HMARK Consultants are to make every effort to resolve the matter between the two parties. In the event a resolution cannot be reached, the Client(s) are to make a complain in writing to HMARK Consultants and allow the HMARK Consultants 30 to 60 days to respond to the Client(s). In the event the dispute is still unresolved, the Client(s) may follow the complaint and discipline procedure outlined by the university you applied for.",
      },
      ...
      },
      {
        ...
        heading: "NOTE: AT THE TIME OF STUDENT VISA APPLICATION",
        intro:
          "Proof of sufficient funds to cover your tuition and living expenses for at least your whole course in AUSTRALIA. Please submit: copies of your bank statement of last six months (Must). Any additional supporting documents demonstrating a reliable source of funds (notarized letter of undertaking and financial documents from personal or immediate family, official letter of scholarship or financial award, investment, income from rental properties, etc.) [NO BANK FINANCE ARE ALLOWED FOR AUSTRALIA VISA. YOU MUST SHOW YOUR OWN PERSONAL MONEY. THERE IS NO GUARANTEE OF VISA; WE ARE JUST RESPONSIBLE TO PROCESS YOUR APPLICATION.]",
      },
      {
        kind: "heading",
        heading: "Authority To Release Personal Information To Designated Universities",
        intro:
          "I, as client authorized HMARK Consultants to serve as my representative and to conduct business and do all type of correspondence on my behalf with the university of AUSTRALIA. I also authorized to release information from my case file and any dependent children under 18 years of age (if applicable). Also I have fully read and understood the agreement and comply with all the clauses in this agreement.",
      },
      {
        kind: "heading",
        heading: "Courier Charges",
        intro: "Client has to bear all DHL charges once DHL launch to AUSTRALIA. We will provide DHL tracking number every time.",
      },
    ],
  },
  ...
  CA_private: {
    ...
    blocks: [
      ...
      {
        kind: "bullet",
        text: "In the event that the CLIENT chooses to terminate this agreement prior to either of the event made registration with HMARK Consultants or submitted for student visa to CANADA, the full amount of the agreement client has to pay.",
      },
      {
        kind: "bullet",
        text: "The client understand that a refusal from university or embassy based on the medical condition, criminality, fraudulent documents, false or misleading information or the ability to meet the admissibility requirements will not be the responsibility of the consultant or the company and there will be no refund made in this condition.",
      ...
      },
      {
        ...
        heading: "NOTE: AT THE TIME OF STUDENT VISA APPLICATION",
        intro:
          "Proof of sufficient funds to cover your tuition and living expenses for at least your whole course in CANADA. Please submit: copies of your bank statement of last six months (Must). Any additional supporting documents demonstrating a reliable source of funds (notarized letter of undertaking and financial documents from personal or immediate family, official letter of scholarship or financial award, investment, income from rental properties, etc.) [NO BANK FINANCE ARE ALLOWED FOR CANADA VISA. YOU MUST SHOW YOUR OWN PERSONAL MONEY. THERE IS NO GUARANTEE OF VISA; WE ARE JUST RESPONSIBLE TO PROCESS YOUR APPLICATION.]",
      },
      {
        kind: "heading",
        heading: "Authority To Release Personal Information To Designated Universities",
        intro:
          "I, as client authorized HMARK Consultants to serve as my representative and to conduct business and do all type of correspondence on my behalf with the universities of CANADA. I also authorized to release information from my case file and any dependent children under 18 years of age (if applicable). Also I have fully read and understood the agreement and comply with all the clauses in this agreement.",
      },
      {
        kind: "heading",
        heading: "Courier Charges",
        intro: "Client has to bear all DHL charges once DHL launch to CANADA. We will provide DHL tracking number every time.",
      },
    ],
  },
  ...
  NC_private: {
    ...
    blocks: [
      ...
      {
        kind: "bullet",
        text: "HMARK Consultants only provide guidance on how to get an accommodation off-campus and not responsible for it. However, the complete assistance can be provided on on-campus accommodation of the university if available or initial arrangement of hotel booking can be provided.",
      },
      {
        kind: "bullet",
        text: "HMARK Consultants only provide assistance to student on Visa documentation and doesn't guarantee any visa issuance.",
      ...
      {
        kind: "bullet",
        text: "Students are required to provide IELTS overall band 6.5 for postgraduate students and 6.0 for Undergraduate students and not less than 6 in each component as it is the English proficiency requirement of the university. Else, an English proficiency test is required to pass before the enrollment at the university. In case of failure, the client is required to take an English preparatory course of one semester and only after successfully passing it, can proceed to the eligible higher education program.",
      },
      { kind: "bullet", text: "Students are required to meet the deadlines of Embassy/Consulate. Else the admission will be deferred to next possible intake." },
      { kind: "bullet", text: "The client is required to provide the information of any kind of visa previously issued or refused." },
      {
      ...
      {
        kind: "bullet",
        text: "In the event that the CLIENT chooses to terminate this agreement prior to either of the event made registration with HMARK Consultants or submitted for student visa to TURKISH REPUBLIC OF NORTHERN CYPRUS, the full amount of the agreement client has to pay.",
      },
      {
        kind: "bullet",
        text: "The client understand that a refusal from university or embassy based on the medical condition, criminality, fraudulent documents, false or misleading information or the ability to meet the admissibility requirements will not be the responsibility of the consultant or the company and there will be no refund made in this condition.",
      ...
      },
      {
        ...
        heading: "NOTE: AT THE TIME OF STUDENT VISA APPLICATION",
        intro:
          "Proof of sufficient funds to cover your tuition and living expenses for at least your whole course in TURKISH REPUBLIC OF NORTHERN CYPRUS. Please submit: copies of your bank statement of last six months (Must). Any additional supporting documents demonstrating a reliable source of funds (notarized letter of undertaking and financial documents from personal or immediate family, official letter of scholarship or financial award, investment, income from rental properties, etc.) [NO BANK FINANCE ARE ALLOWED FOR TURKISH REPUBLIC OF NORTHERN CYPRUS VISA. YOU MUST SHOW YOUR OWN PERSONAL MONEY. THERE IS NO GUARANTEE OF VISA; WE ARE JUST RESPONSIBLE TO PROCESS YOUR APPLICATION.]",
      },
      {
        kind: "heading",
        heading: "Authority To Release Personal Information To Designated Universities",
        intro:
          "I, as client authorized HMARK Consultants to serve as my representative and to conduct business and do all type of correspondence on my behalf with the university of TURKISH REPUBLIC OF NORTHERN CYPRUS, only Near East University, Near East College, Middle East Technical University, Eastern Mediterranean University, University of Kyrenia, European University of Lefke and Cyprus International University. I also authorized to release information from my case file and any dependent children under 18 years of age (if applicable). Also I have fully read and understood the agreement and comply with all the clauses in this agreement.",
      },
      {
        kind: "heading",
        heading: "Courier Charges",
        intro: "Client has to bear all DHL charges once DHL launch to TURKISH REPUBLIC OF NORTHERN CYPRUS. We will provide DHL tracking number every time.",
      },
    ],
  },

  // TR_private adapted from NC_private (TRNC) at the user's direction
  // (2026-08-28) — no source .docx exists for Turkey in reference/Agreements/,
  // and Turkey/TRNC are the closest existing private-track pair (same
  // region, same style of contract). Same two deviations used for Ireland
  // and the AT/FR/FI/LU set: the "[NO BANK FINANCE...]" bracket is dropped
  // (unverified for Turkey's visa rules), and the TRNC clause naming seven
  // specific partner universities by name is generalized to "the university
  // in Turkey" rather than listing Turkey's partner universities, since
  // "official representative of" is a specific legal claim about those
  ...
  TR_private: {
    ...
    blocks: [
      ...
      {
        kind: "bullet",
        text: "In the event that the CLIENT chooses to terminate this agreement prior to either of the event made registration with HMARK Consultants or submitted for student visa to Turkey, the full amount of the agreement client has to pay.",
      },
      {
        kind: "bullet",
        text: "The client understand that a refusal from university or embassy based on the medical condition, criminality, fraudulent documents, false or misleading information or the ability to meet the admissibility requirements will not be the responsibility of the consultant or the company and there will be no refund made in this condition.",
      ...
      },
      {
        ...
        heading: "NOTE: AT THE TIME OF STUDENT VISA APPLICATION",
        intro:
          "Proof of sufficient funds to cover your tuition and living expenses for at least your whole course in Turkey. Please submit: copies of your bank statement of last six months (Must). Any additional supporting documents demonstrating a reliable source of funds (notarized letter of undertaking and financial documents from personal or immediate family, official letter of scholarship or financial award, investment, income from rental properties, etc.). THERE IS NO GUARANTEE OF VISA; WE ARE JUST RESPONSIBLE TO PROCESS YOUR APPLICATION.",
      },
      {
        kind: "heading",
        heading: "Authority To Release Personal Information To Designated Universities",
        intro:
          "I, as client authorized HMARK Consultants to serve as my representative and to conduct business and do all type of correspondence on my behalf with the university in Turkey. I also authorized to release information from my case file and any dependent children under 18 years of age (if applicable). Also I have fully read and understood the agreement and comply with all the clauses in this agreement.",
      },
      {
        kind: "heading",
        heading: "Courier Charges",
        intro: "Client has to bear all DHL charges once DHL launch to Turkey. We will provide DHL tracking number every time.",
      },
    ],
  },
  ...
  UK_private: {
    ...
    blocks: [
      ...
      {
        kind: "bullet",
        text: "In the event that the CLIENT chooses to terminate this agreement prior to either of the events made registration with HMARK Consultants or submitted for student visa to UK, the full amount of the agreement client has to pay.",
      },
      {
        kind: "bullet",
        text: "The client understands that a refusal from university or embassy based on the medical condition, criminality, fraudulent documents, false or misleading information or the ability to meet the admissibility requirements will not be the responsibility of the consultant or the company and there will be no refund made in this condition.",
      ...
      },
      {
        ...
        heading: "NOTE: AT THE TIME OF STUDENT VISA APPLICATION",
        intro:
          "Proof of sufficient funds to cover your tuition and living expenses for at least your whole course in UK. Please submit: copies of your bank statement of last six months (Must). Any additional supporting documents demonstrating a reliable source of funds (notarized letter of undertaking and financial documents from personal or immediate family, official letter of scholarship or financial award, investment, income from rental properties, etc.) [NO BANK FINANCE ARE ALLOWED FOR UK VISA. YOU MUST SHOW YOUR OWN PERSONAL MONEY. THERE IS NO GUARANTEE OF VISA; WE ARE JUST RESPONSIBLE TO PROCESS YOUR APPLICATION.]",
      },
      {
        kind: "heading",
        heading: "Authority To Release Personal Information To Designated Universities",
        intro:
          "I, as client authorized HMARK Consultants to serve as my representative and to conduct business and do all type of correspondence on my behalf with the university of UK. I also authorized to release information from my case file and any dependent children under 18 years of age (if applicable). Also I have fully read and understood the agreement and comply with all the clauses in this agreement.",
      },
      {
        kind: "heading",
        heading: "Courier Charges",
        intro: "Client has to bear all DHL charges once DHL launch to the UK. We will provide a DHL tracking number every time.",
      },
    ],
  },

  // Adapted from UK_private at the user's direction (2026-08-28) — no source
  // .docx exists for Ireland in reference/Agreements/. Same structure and
  // fee/refund policy as the UK contract, with country references swapped
  // to Ireland. The UK contract's bracketed "[NO BANK FINANCE ARE ALLOWED
  // FOR UK VISA...]" claim was dropped rather than swapped to Ireland since
  ...
  IE_private: {
    ...
    blocks: [
      ...
      {
        kind: "bullet",
        text: "In the event that the CLIENT chooses to terminate this agreement prior to either of the events made registration with HMARK Consultants or submitted for student visa to Ireland, the full amount of the agreement client has to pay.",
      },
      {
        kind: "bullet",
        text: "The client understands that a refusal from university or embassy based on the medical condition, criminality, fraudulent documents, false or misleading information or the ability to meet the admissibility requirements will not be the responsibility of the consultant or the company and there will be no refund made in this condition.",
      ...
      },
      {
        ...
        heading: "NOTE: AT THE TIME OF STUDENT VISA APPLICATION",
        intro:
          "Proof of sufficient funds to cover your tuition and living expenses for at least your whole course in Ireland. Please submit: copies of your bank statement of last six months (Must). Any additional supporting documents demonstrating a reliable source of funds (notarized letter of undertaking and financial documents from personal or immediate family, official letter of scholarship or financial award, investment, income from rental properties, etc.). THERE IS NO GUARANTEE OF VISA; WE ARE JUST RESPONSIBLE TO PROCESS YOUR APPLICATION.",
      },
      {
        kind: "heading",
        heading: "Authority To Release Personal Information To Designated Universities",
        intro:
          "I, as client authorized HMARK Consultants to serve as my representative and to conduct business and do all type of correspondence on my behalf with the university of Ireland. I also authorized to release information from my case file and any dependent children under 18 years of age (if applicable). Also I have fully read and understood the agreement and comply with all the clauses in this agreement.",
      },
      {
        kind: "heading",
        heading: "Courier Charges",
        intro: "Client has to bear all DHL charges once DHL launch to Ireland. We will provide a DHL tracking number every time.",
      },
    ],
  },
  ...
  US_private: {
    ...
    blocks: [
      ...
      {
        kind: "bullet",
        text: "Students are required to provide IELTS overall band 6.5 for postgraduate and Undergraduate students and not less than 6 in each component as it is the mandatory requirement of the universities and Embassy/Consulate.",
      },
      { kind: "bullet", text: "Students are required to meet the deadlines of Embassy/Consulate. Else the admission will be deferred to next possible intake." },
      { kind: "bullet", text: "The client is required to provide the information of any kind of visa previously issued or refused." },
      {
      ...
      {
        kind: "bullet",
        text: "In the event that the CLIENT chooses to terminate this agreement prior to either of the event made registration with HMARK Consultants or submitted for student visa to USA, the full amount of the agreement client has to pay.",
      },
      {
        kind: "bullet",
        text: "The client understand that a refusal from university or embassy based on the medical condition, criminality, fraudulent documents, false or misleading information or the ability to meet the admissibility requirements will not be the responsibility of the consultant or the company and there will be no refund made in this condition.",
      ...
      },
      {
        ...
        heading: "NOTE: AT THE TIME OF STUDENT VISA APPLICATION",
        intro:
          "Proof of sufficient funds to cover your tuition and living expenses for at least your whole course in USA. Please submit: copies of your bank statement of last six months (Must). Any additional supporting documents demonstrating a reliable source of funds (notarized letter of undertaking and financial documents from personal or immediate family, official letter of scholarship or financial award, investment, income from rental properties, etc.) [NO BANK FINANCE ARE ALLOWED FOR USA VISA. YOU MUST SHOW YOUR OWN PERSONAL MONEY. THERE IS NO GUARANTEE OF VISA; WE ARE JUST RESPONSIBLE TO PROCESS YOUR APPLICATION.]",
      },
      {
        kind: "heading",
        heading: "Authority To Release Personal Information To Designated Universities",
        intro:
          "I, as client authorized HMARK Consultants to serve as my representative and to conduct business and do all type of correspondence on my behalf with the university of USA. I also authorized to release information from my case file and any dependent children under 18 years of age (if applicable). Also I have fully read and understood the agreement and comply with all the clauses in this agreement.",
      },
      {
        kind: "heading",
        heading: "Courier Charges",
        intro: "Client has to bear all DHL charges once DHL launch to USA. We will provide DHL tracking number every time.",
      },
    ],
  },
};
