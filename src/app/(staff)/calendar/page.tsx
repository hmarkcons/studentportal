...
type Event = { date: string; type: string; label: string; tone: "warning" | "danger" | "info" };
...
export default async function CalendarPage() {
  ...
  const { data: tasks } = await supabase
    ...
    .select("id, description, due_date, application:applications(student:leads(full_name))")
    .eq("status", "pending")
